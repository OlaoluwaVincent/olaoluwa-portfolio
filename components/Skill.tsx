	...
	return (
		<div className='group relative flex cursor-pointer'>
			<motion.img
				...
				className='rounded-full object-contain border border-gray-500 w-16 h-16 max-w-none md:w-20 md:h-20 xl:w-24 xl:h-24 filter group-hover:grayscale transition duration-300 ease-in-out '
			/>
